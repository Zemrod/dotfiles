...
#            ),
            widget.GroupBox(active=colors.color1, inactive=colors.color5,
                            this_current_screen_border=colors.color2, this_screen_border=colors.color5, hide_unused=False, fontsize=18),
            widget.Sep(foreground=colors.color5, fontsize=18),
            widget.Prompt(foreground=colors.color1, fontsize=18),
            widget.Memory(foreground=colors.color1, fontsize=18),
            widget.Sep(foreground=colors.color5, fontsize=18),
            widget.Net(foreground=colors.color1, interface="enp0s20f0u4", fontsize=18),
            widget.Chord(
                chords_colors={
            ...
            widget.GenPollText(func=lambda: subprocess.check_output("syspart.sh").decode("utf-8"), update_interval=10,
                               foreground=colors.color1, fontsize=18),
            widget.Sep(foreground=colors.color5, fontsize=18),
            widget.Battery(foreground=colors.color1, update_interval=10, fontsize=18),
            widget.Sep(foreground=colors.color5, fontsize=18),
          ...
          # widget.Sep(foreground=colors.color5),
            widget.GenPollText(func=lambda: subprocess.check_output("kernel.sh").decode("utf-8"), update_interval=1000,
                               foreground=colors.color1, fontsize=18),
            widget.Sep(foreground=colors.color5, fontsize=18),
            widget.Clock(foreground=colors.color1, format='%Y-%m-%d %a %I:%M %p', fontsize=18),
            widget.Systray(),
        ],
        32,
...
#            ),
            ...
            widget.Sep(foreground=colors.color5),
            widget.Net(foreground=colors.color1, interface="enp0s20f0u4"),
            widget.Chord(
                chords_colors={
                    'launch': ("#ff0000", "#ffffff"),
                },
