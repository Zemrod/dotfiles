    ...
    Screen(
        top=bar.Bar(
            [
                ...
                widget.Sep(foreground=colors.color2),
                ...
                widget.Sep(foreground=colors.color2),
                widget.GenPollText(func=lambda: subprocess.check_output("kernel").decode("utf-8"), update_interval=1000,
                                   foreground=colors.color1),
                widget.Sep(foreground=colors.color2),
