...
beautiful.border_focus = colors.color1
beautiful.border_normal = colors.color5
beautiful.border_width = 2

beautiful.bg_systray = colors.background

beautiful.tasklist_bg_normal = colors.background
beautiful.tasklist_fg_normal = colors.color5
beautiful.tasklist_bg_focus = colors.background
beautiful.tasklist_fg_focus = colors.color1

beautiful.taglist_bg_normal = colors.background
beautiful.taglist_fg_normal = colors.color5
beautiful.taglist_bg_focus = colors.color4
beautiful.taglist_fg_focus = colors.color1
